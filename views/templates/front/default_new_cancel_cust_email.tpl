                    ...
                    <tbody>
                        ...
                        line-height:20px">Greetings from {$shop_name nofilter}!</p>
                                ...
                                <p style="padding:20px 0 0 0;margin:0;color:#565656;line-height:20px">
                                    Your Order cancellation request has been received for your order
                         ...
                         margin:10px 0 0 0;text-align:left;line-height:20px">
                                        Please keep in mind that this is only the first step of the order cancellation
                                        process.
                                        The request has to be approved by shop owner in order to further process the
                                        request.
                                        You will be notified once the shop owner approves this cancellation request.<br>
                                    </p>
                                </span>
                            </td>
                        </tr>
