                    ...
                    <tbody>
                        <tr>
                            <td align="left" valign="top" style="margin:0;padding:25px 20px 5px 25px" bgcolor="FFFFFF">
                                ...
                                <p style="padding:20px 0 0 0;margin:0;color:#565656;line-height:20px">
                                    A customer has just replied on the #{$ticket_number nofilter} ticket in reference to return
                                    request #{$return_id nofilter}.</span>.
                                </p>
                            </td>
                        </tr>
                        <tr>
                                        ...
                                        <td style="padding:7px 0">
                                            <font size="2" face="Open-sans, sans-serif" color="#555454">
                                                <span style="color:#777">
                                                    ...
                                                    <span style="color:#333"><strong>Message:</strong></span> {$message nofilter}
                                                    <br /><br />
                                                </span>
                                            </font>
                                        </td>
                                        ...
                                        <td style="padding:7px 0">
                                            ...
                                            <font size="2" face="Open-sans, sans-serif" color="#555454">
                                                <span style="color:#777">
                                                    ...
                                                    {$customer_name nofilter}<br />
                                                    <span style="color:#333"><strong>Email:</strong></span>
                                                    {$customer_email nofilter}
                                                </span>
                                            </font>
                                        </td>
                                        <td width="10" style="padding:7px 0">&nbsp;</td>
                        ...
                        <tr>
                            <td class="linkbelow" style="padding:7px 0">
                                <span>Please reply for customer issue as soon as possible.</span>
                            </td>
                        </tr>
