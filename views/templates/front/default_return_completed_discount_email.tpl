            ...
            <td colspan="9" align="center" valign="top">
                <table width="100%" style="border:1px solid #e6e6e6;width:100%" cellpadding="0" cellspacing="0">
                    <tbody>
                        ...
                        font-size:16px;font-weight:bold"> Dear {$customer_full_name nofilter}, </p>
                                    <p style="padding:20px 0 0 0;
                        margin:0;color:#565656;line-height:20px">Greetings from {$shop_name nofilter}!</p>
                                </span>
                                <p style="padding:20px 0 0 0;margin:0;color:#565656;line-height:20px">
                                    We are pleased to inform you that your return request for the following item in your
                                    order
                                    <span style="color:#00648b"> <a href="{$order_history_link nofilter}"
                                            target="_blank">{$order_reference nofilter}</a>
                                    </span> has been marked completed by the store owner. We are offering you a discount
                                    coupon of <strong>{$amount nofilter}</strong> as refund. You can avail the dicount on any
                                    purchase with the Coupon Code.
                                </p>
                            </td>
                        </tr>
                        <tr>
                            <td align="center" valign="top" style="padding:20px 20px 0 20px">
                                <h2><strong>Coupon Code : {$coupon_code nofilter} </strong></h2>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td align="left" valign="top" style="margin:0;padding:25px 20px 5px 25px" bgcolor="FFFFFF">
                                ...
                                <p style="padding:19px 0 0 0;margin:0;color:#565656;line-height:19px">
                                    ...
                                    <span style="color:#00648b"> <a href="{$signin_link nofilter}"
