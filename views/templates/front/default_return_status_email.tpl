                            ...
                            <td align="left" valign="top" style="margin:0;padding:25px 20px 5px 25px" bgcolor="FFFFFF">
                                ...
                                <p style="padding:20px 0 0 0;margin:0;color:#565656;line-height:20px">
                                    ...
                                    <span style="color:#00648b"> <a href="{$order_history_link nofilter}"
                                            target="_blank">{$order_reference nofilter}</a></span> has been updated by the
                                    store owner.
                                </p>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td align="left" valign="top" style="margin:0;padding:25px 20px 5px 25px" bgcolor="FFFFFF">
                                ...
                                <p style="padding:19px 0 0 0;margin:0;color:#565656;line-height:19px">
                                    Return Status has been changed from <b>{$previous_status nofilter}</b> to <b>{$current_status nofilter}
                                    </b>.
                                </p>

                                <p style="padding:19px 0 0 0;margin:0;color:#565656;line-height:19px">
                                    To know more about the return request you have to <span style="color:#00648b">
                                        <a href="{$signin_link nofilter}" target="_blank">login</a>
