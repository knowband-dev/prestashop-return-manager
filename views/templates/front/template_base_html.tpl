...
<head>
    ...
    <title>Message from {$shop_name nofilter}</title>
    <style>
                ...
                <table class="table" style="width:100%">
                    <tr>
                        <td align="center" class="logo" style="border-bottom:4px solid #333333;padding:7px 0">
                            <a title="{$shop_name nofilter}" href="{$shop_url nofilter}" style="color:#337ff1">
                                <img src="{$shop_logo nofilter}" alt="{$shop_name nofilter}" />
                            </a>
                        </td>
                    </tr>
                    <tr>
                        {$template_content nofilter}
                    </tr>
                </table>
            </td>
        </tr>
