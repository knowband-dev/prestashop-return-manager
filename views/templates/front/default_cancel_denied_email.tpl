                            ...
                            <td align="left" valign="top" style="margin:0;padding:25px 20px 5px 25px" bgcolor="FFFFFF">
                                <span>
                                    <p style="padding:0 0 0 0;margin:0;font-size:16px;font-weight:bold">
                                        Dear {$customer_full_name nofilter}, </p>
                                    <p style="padding:20px 0 0 0;margin:0;color:#565656;line-height:20px">
                                        Greetings from {$shop_name nofilter}!</p>
                                </span>
                                <p style="padding:20px 0 0 0;margin:0;color:#565656;line-height:20px">
                                    We are sorry to inform you that your cancellation request for the following
                                    order <span style="color:#00648b">
                                        <a href="{$order_history_link nofilter}" target="_blank">{$order_reference nofilter}</a>
                        ...
                        <tr>
                            <td align="left" valign="top" style="margin:0;padding:25px 20px 5px 25px" bgcolor="FFFFFF">
                                <p style="margin:0;color:#565656;line-height:20px">
                                    <b>Cancel id for this request is : #{$cancel_id nofilter}</b>
                                </p>
